...
public class DevolverLibroWindow extends JFrame {
    ...
    public DevolverLibroWindow(BibliotecaDAO dao) {
        ...
        // Título
        JLabel titleLabel = new JLabel("Formulario de Devolución de Libro", JLabel.CENTER);
    ...
    private void devolverLibro() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error al devolver libro: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
}
